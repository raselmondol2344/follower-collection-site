      ...
      <div className="w-full h-full rounded-lg bg-black/50 flex items-center ">
        <div className="max-w-7xl mx-auto px-6 text-white">
          ...
          <div className="flex gap-4 items-center">
            <Link href="#">
              <Button className="bg-linear-to-r from-pink-500 via-purple-500 bg-red-500 rounded-full p-2">
                Generate Now
              </Button>
            </Link>

            <Link href="/pricing">
              <Button variant="outline" className="text-white border border-white rounded-full p-2">
                View Pricing
              </Button>
            </Link>
          </div>
